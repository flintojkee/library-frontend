...
function validatePattern(pattern: string | RegExp, control: AbstractControl): ValidationErrors {
...
export function requiredTrueValidator(msg?: string): ValidatorFn {
  return (control: AbstractControl): ValidationMessage => {
    if (
      (Validators.required(control) && Validators.required(control).required) ||
      control.value !== true
    ) {
      return {
        required: msg
...
export function minLengthValidator(msg?: string, minLength?: number): ValidatorFn {
  return (control: AbstractControl): ValidationMessage => {
...
export function maxLengthValidator(msg?: string, maxLength?: number): ValidatorFn {
  return (control: AbstractControl): ValidationMessage => {
...
export function emailValidator(msg?: string, emailPattern?: string | RegExp): ValidatorFn {
  return (control: AbstractControl): ValidationMessage => {
...
export function patternValidator(msg?: string, patternExpression?: string | RegExp): ValidatorFn {
  return (control: AbstractControl): ValidationMessage => {
...
export function passwordValidator(msg?: string, customPattern?: string | RegExp): ValidatorFn {
  return (control: AbstractControl): ValidationMessage => {
    const defaultPattern = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{7,}$/;
...
export function passwordMatchValidator(password: AbstractControl, msg?: string): ValidatorFn {
  return (control: AbstractControl): ValidationMessage => {
